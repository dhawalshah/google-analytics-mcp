...
project: it runs against live GA4 accounts every week, which is why the
...
I write up the routines and agents I actually run at [dhawalshah.net](https://www.dhawalshah.net/about/?utm_source=github.com&utm_medium=referral&utm_campaign=google-analytics-mcp&utm_content=readme).

Worth reading alongside this repo: [Claude Code for Marketing: Every Channel from One Terminal](https://www.dhawalshah.net/article/claude-code-for-marketing/?utm_source=github.com&utm_medium=referral&utm_campaign=google-analytics-mcp&utm_content=readme).
